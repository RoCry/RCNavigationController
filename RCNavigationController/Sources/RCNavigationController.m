...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer {
    ...
    [[self.visibleViewController class] conformsToProtocol:@protocol(RCNavigationDelegate)] ?
    (UIViewController<RCNavigationDelegate> *)self.visibleViewController : nil;
...
- (void)handlePan:(UIPanGestureRecognizer *)panGesture {
    switch (panGesture.state)
    {
        ...
        case UIGestureRecognizerStateEnded:
        {
            ...
            if (popTriggered) {
                UIViewController<RCNavigationDelegate> *delegate =
                [self.visibleViewController conformsToProtocol:@protocol(RCNavigationDelegate)] ?
                (UIViewController<RCNavigationDelegate> *)self.visibleViewController : nil;
